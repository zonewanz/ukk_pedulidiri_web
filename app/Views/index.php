...
<head>
    ...
    <title>Login | Aplikasi Catatan PeduliDiri</title>

    <meta name="description" content="Aplikasi Catatan Perjalanan UKK RPL" />
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="index.html" method="POST">
                            ...
                            <div class="mb-3">
                                <input type="submit" class="btn btn-primary d-grid w-100" value="Login" name="submit">
                            </div>
                        </form>
