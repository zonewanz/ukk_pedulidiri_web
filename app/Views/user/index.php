...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="tema/assets/img/favicon/favicon.ico" />
    ...
    <link rel="stylesheet" href="tema/assets/vendor/css/theme-default.css" class="template-customizer-theme-css" />
...
<body>
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">pedulidiri</span>
                    </a>
                            ...
                            <div class="col-lg-12 mb-4 order-0">
                                <div class="card">
                                    <div class="d-flex align-items-end row">
                                        <div class="col-sm-7">
                                            <div class="card-body">
                                                <h5 class="card-title text-primary">Selamat Datang <span class="fw-bold">Username</span>!</h5>
                                                <p class="mb-4">
    ...
    <script src="tema/assets/vendor/libs/jquery/jquery.js"></script>
    <script src="tema/assets/vendor/libs/popper/popper.js"></script>
    <script src="tema/assets/vendor/js/bootstrap.js"></script>
    <script src="tema/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>

    <script src="tema/assets/vendor/js/menu.js"></script>
    <!-- endbuild -->

    <!-- Vendors JS -->
    <script src="tema/assets/vendor/libs/apex-charts/apexcharts.js"></script>

    <!-- Main JS -->
    <script src="tema/assets/js/main.js"></script>

    <!-- Page JS -->
    <script src="tema/assets/js/dashboards-analytics.js"></script>
